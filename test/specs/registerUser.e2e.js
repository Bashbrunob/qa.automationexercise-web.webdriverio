...
describe('Fluxo de Cadastro de Usuário', () => {
    ...
    // Sênior: Dados dinâmicos e isolados
    const usuario = UserData.getNewUser();

    beforeEach(async () => {
        // PREPARAÇÃO: Abrir via Page Object (Melhor Prática)
        await HomePage.open();
        // A validação fica aqui para garantir que a preparação funcionou
